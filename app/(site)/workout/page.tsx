...
const EXERCISES: ExCard[] = [
  ...
  // ── PULL extra (61–70) ───────────────────────────────────────────────────────
  { id:61, type:'PULL', name:'Meadows Row',         muscle:'Lats & Mid Back',    equipment:'Barbell',
    description:'Unilateral landmine row that allows heavy loading with superior lat stretch at the bottom.',
    steps:['Place one end of barbell in a corner. Stand sideways, grip the sleeve with outside hand.','Row the bar up toward hip, elbow flares wide.','Lower with full control, letting shoulder blade protract.'],
    levels:{ novice:'3×8 per side — light, feel the lat stretch', beginner:'3×10 per side moderate', intermediate:'4×10 per side — heavy, 2s hold at top', advanced:'4×8 per side — maximum load', elite:'5×8 per side — straps allowed, drop set finish' }},
  { id:62, type:'PULL', name:'Pendlay Row',          muscle:'Mid Back & Traps',   equipment:'Barbell',
    description:'Dead-stop barbell row from the floor — develops explosive back power and teaches bracing.',
    steps:['Bar on floor, torso horizontal. Grip just outside shoulder-width.','Explosively pull bar to lower chest in one powerful movement.','Return bar to floor — dead stop — before each rep.'],
    levels:{ novice:'3×5 light — horizontal torso and dead stop are mandatory', beginner:'3×6 moderate', intermediate:'4×5 heavy — focus on the explosive pull', advanced:'4×4 at 80%+ max', elite:'5×3 at 90%+ — pure strength focus' }},
  { id:63, type:'PULL', name:'Straight-Arm Pulldown',muscle:'Lats',              equipment:'Cable Machine',
    description:'Isolates the lats through a long range of motion without involving the biceps.',
    steps:['Stand at high cable, grip bar or rope with straight arms.','Keeping arms straight, pull bar down to thighs in an arc.','Return slowly — lats stay engaged the whole way up.'],
    levels:{ novice:'3×15 very light — arms must stay straight', beginner:'3×15 light', intermediate:'4×12 moderate — pause at bottom', advanced:'4×12 heavy — rope variation for peak contraction', elite:'5×12 heavy — super-set with pull-ups' }},
  { id:64, type:'PULL', name:'Chest-Supported Row',  muscle:'Mid Back & Rhomboids',equipment:'Dumbbell',
    description:'Incline bench row that eliminates lower back involvement and forces strict back contraction.',
    steps:['Set bench to 30–45°. Lie face down, dumbbells hanging straight.','Row dumbbells up toward hips, squeezing shoulder blades at top.','Lower fully — no swinging allowed.'],
    levels:{ novice:'3×12 light per side', beginner:'3×12 moderate', intermediate:'4×10 heavy', advanced:'4×8 very heavy — 2s pause at top', elite:'5×10 — plate-loaded or barbell version' }},
  { id:65, type:'PULL', name:'Single-Arm Cable Row', muscle:'Lats & Mid Back',   equipment:'Cable Machine',
    description:'Unilateral cable row that improves left/right balance and allows a fuller range of motion.',
    steps:['Set cable to low position. Sit or stand, grip single handle.','Row handle to hip, rotating torso slightly for extra range.','Return with control — fully extend arm and let shoulder stretch.'],
    levels:{ novice:'3×12 per side light', beginner:'3×12 per side moderate', intermediate:'4×10 per side heavy', advanced:'4×8 per side — 3s negative', elite:'5×10 per side — max load, partial reps at failure' }},
  { id:66, type:'PULL', name:'Preacher Curl',        muscle:'Biceps',             equipment:'Barbell',
    description:'Locked curl on a preacher bench that removes cheating and maximises bicep stretch at the bottom.',
    steps:['Sit at preacher bench, upper arms flat on pad. Grip EZ-bar.','Curl fully up — elbows stay on pad throughout.','Lower slowly to full extension — feel the stretch at bottom.'],
    levels:{ novice:'3×10 very light — full range only', beginner:'3×12 light', intermediate:'4×10 moderate — 3s lower', advanced:'4×8 heavy — strip set at end', elite:'5×8 heavy + partial reps at bottom for extra stretch' }},
  { id:67, type:'PULL', name:'Cable Curl',           muscle:'Biceps',             equipment:'Cable Machine',
    description:'Constant-tension curl that keeps biceps loaded even at the top — unlike free weights.',
    steps:['Stand at low cable, attach straight bar or EZ attachment.','Curl bar up to chin with full supination.','Lower slowly — cable maintains tension at full extension.'],
    levels:{ novice:'3×15 light — feel constant tension', beginner:'3×15 moderate', intermediate:'4×12 heavy', advanced:'4×10 — rope attachment for peak contraction', elite:'5×10 heavy — super-set with hammer curl' }},
  { id:68, type:'PULL', name:'Spider Curl',          muscle:'Long Head Biceps',   equipment:'Dumbbell',
    description:'Prone incline curl that locks the arm forward, completely isolating the bicep peak.',
    steps:['Lie face-down on incline bench (45°), arms hanging straight.','Curl dumbbells up — upper arms stay perpendicular to floor.','Lower fully for maximum stretch.'],
    levels:{ novice:'3×10 light — strict form only', beginner:'3×12 moderate', intermediate:'4×10 heavy — 2s peak hold', advanced:'4×8 very heavy — barbell variation', elite:'5×8 — cable variation for constant tension' }},
  { id:69, type:'PULL', name:'Zottman Curl',         muscle:'Biceps & Forearms',  equipment:'Dumbbell',
    description:'Combines supinated up-phase for bicep peak with pronated down-phase for brachialis and forearms.',
    steps:['Curl dumbbells up with palms facing up — standard bicep curl.','At the top, rotate wrists so palms face down.','Lower slowly with overhand grip — full range.'],
    levels:{ novice:'3×10 light — master the rotation first', beginner:'3×10 moderate', intermediate:'4×10 moderate-heavy', advanced:'4×8 heavy — 3s descent', elite:'5×8 heavy — seated incline variation' }},
  { id:70, type:'PULL', name:'Concentration Curl',   muscle:'Biceps Peak',        equipment:'Dumbbell',
    description:'Arnold\'s favourite for bicep peak — strict isolation with elbow braced against inner thigh.',
    steps:['Sit, elbow braced against inner thigh, dumbbell hanging.','Curl fully up, supinate at top for peak contraction.','Lower slowly — elbow stays against leg throughout.'],
    levels:{ novice:'3×12 light per arm', beginner:'3×12 moderate', intermediate:'4×10 heavy — squeeze hard at top', advanced:'4×8 very heavy — 3s hold at peak', elite:'5×8 — max weight + 3 forced reps with free hand' }},

  // ── PUSH extra (71–80) ───────────────────────────────────────────────────────
  { id:71, type:'PUSH', name:'Dumbbell Bench Press', muscle:'Chest & Triceps',   equipment:'Dumbbell',
    description:'Greater range of motion than barbell bench — each arm works independently, fixing imbalances.',
    steps:['Lie on flat bench, dumbbells at chest level, palms forward.','Press up until arms nearly locked — let dumbbells travel slightly inward.','Lower beyond bar depth for extra pec stretch.'],
    levels:{ novice:'3×10 light — learn independent movement', beginner:'3×10 moderate', intermediate:'4×8 heavy', advanced:'4×8 very heavy — 3s descent', elite:'5×6 max — wrist rotation at top for extra contraction' }},
  { id:72, type:'PUSH', name:'Floor Press',          muscle:'Chest & Triceps',   equipment:'Barbell',
    description:'Barbell press from the floor — limits range of motion and overloads the tricep lockout.',
    steps:['Lie on floor, knees bent, feet flat. Set bar in rack or have it handed.','Lower bar until triceps touch floor — pause 1 sec.','Press explosively to full lockout.'],
    levels:{ novice:'3×8 light — feel the pause', beginner:'3×10 moderate', intermediate:'4×8 at 75% bench max', advanced:'4×5 at 85%+', elite:'5×3 at 90%+ — peak tricep strength builder' }},
  { id:73, type:'PUSH', name:'Landmine Press',       muscle:'Shoulders & Chest', equipment:'Barbell',
    description:'Shoulder-friendly angled press — great for athletes and anyone with overhead mobility issues.',
    steps:['Fix one end of bar in landmine or corner. Grip the other end at shoulder.','Press bar up and forward in an arc, fully extending arm.','Return to shoulder — keep core tight throughout.'],
    levels:{ novice:'3×10 per side very light', beginner:'3×10 moderate', intermediate:'4×10 heavy', advanced:'4×8 — alternating arms', elite:'5×8 — kneeling + alternating for core challenge' }},
  { id:74, type:'PUSH', name:'Close-Grip Bench Press',muscle:'Triceps & Chest',  equipment:'Barbell',
    description:'Narrow grip bench press that shifts emphasis dramatically to the triceps.',
    steps:['Grip bar at shoulder-width (not too close — wrists must stay neutral).','Lower bar to lower chest, elbows tucked close to body.','Press to full lockout — squeeze triceps hard at top.'],
    levels:{ novice:'3×10 light — protect the wrists', beginner:'3×10 moderate', intermediate:'4×8 at 70% flat max', advanced:'4×6 at 80%+', elite:'5×4 at 85%+ — super-set with skull crushers' }},
  { id:75, type:'PUSH', name:'Cable Lateral Raise',  muscle:'Medial Deltoid',   equipment:'Cable Machine',
    description:'Cable version of lateral raise — constant tension prevents the common "cheat" at the bottom.',
    steps:['Stand sideways to low cable, grip single handle with far hand.','Raise arm out to side to shoulder height.','Lower slowly — cable stays taut the whole way down.'],
    levels:{ novice:'3×15 per side light', beginner:'3×15 per side moderate', intermediate:'4×15 per side — 1.5 rep method', advanced:'4×20 per side heavy', elite:'5×20 per side — cross-body cable for peak contraction' }},
  { id:76, type:'PUSH', name:'Dumbbell Shoulder Press',muscle:'Shoulders',      equipment:'Dumbbell',
    description:'Seated or standing shoulder press with dumbbells — greater range and balance challenge vs barbell.',
    steps:['Hold dumbbells at shoulder height, palms facing forward.','Press both dumbbells up until arms fully extended overhead.','Lower with control back to start.'],
    levels:{ novice:'3×10 light seated', beginner:'3×12 moderate', intermediate:'4×10 heavy', advanced:'4×8 very heavy — 3s lower', elite:'5×8 — standing, max load, core stabilisation challenge' }},
  { id:77, type:'PUSH', name:'Pike Push-up',         muscle:'Shoulders & Triceps',equipment:'Bodyweight',
    description:'Bodyweight overhead press substitute — the foundation for handstand push-up progression.',
    steps:['Form an inverted V: hands on floor, hips high, legs straight.','Lower crown of head toward floor by bending elbows.','Push back up to start — keep hips elevated throughout.'],
    levels:{ novice:'3×5 — small range to learn movement', beginner:'3×8 full range', intermediate:'4×10 — feet elevated on bench', advanced:'4×12 elevated — slow tempo', elite:'5×8 — wall-supported handstand push-up' }},
  { id:78, type:'PUSH', name:'Tricep Kickback',      muscle:'Triceps',          equipment:'Dumbbell',
    description:'Isolation movement for the triceps at peak contraction — best done light with strict form.',
    steps:['Hinge forward, upper arm parallel to floor, elbow at 90°.','Extend arm straight back until fully locked out.','Hold 1 sec at top, lower slowly.'],
    levels:{ novice:'3×15 light per arm — strict elbow position', beginner:'3×15 moderate', intermediate:'4×12 heavy — 2s hold', advanced:'4×10 very heavy — cable variation', elite:'5×12 — cable bilateral version for max TUT' }},
  { id:79, type:'PUSH', name:'Machine Chest Press',  muscle:'Chest',            equipment:'Machine',
    description:'Chest press machine — great for beginners, warm-ups, or training to failure safely.',
    steps:['Adjust seat so handles are at chest height.','Press handles forward until arms fully extended.','Return slowly — do not let weight stack touch down between reps.'],
    levels:{ novice:'3×12 light — full range of motion', beginner:'3×15 moderate', intermediate:'4×12 heavy — slow 4s negative', advanced:'4×10 very heavy — drop set', elite:'5×10 max — partial reps at failure + drop set' }},
  { id:80, type:'PUSH', name:'Deficit Push-up',      muscle:'Chest & Triceps',  equipment:'Bodyweight',
    description:'Push-up with hands elevated on blocks or plates — allows deeper range for more pec stretch.',
    steps:['Place hands on two raised surfaces (plates, books) — slightly wider than shoulder.','Lower chest below hand level — full deep stretch.','Push up explosively to full lockout.'],
    levels:{ novice:'3×5 small deficit (2 cm)', beginner:'3×8 moderate deficit (5 cm)', intermediate:'4×12 full deficit (10 cm)', advanced:'4×15 — add slow 3s descent', elite:'5×15 — rings or blast straps for unstable deficit' }},

  // ── ABS & LEGS extra (81–90) ──────────────────────────────────────────────────
  { id:81, type:'ABS_LEGS', name:'Box Squat',            muscle:'Quads & Glutes',  equipment:'Barbell',
    description:'Squat to a box that teaches proper hinge-back and eliminates knee drift — great for raw strength.',
    steps:['Set box just below parallel height. Bar on upper traps.','Sit back onto box — hips push back first, not knees forward.','Pause on box, then drive up explosively.'],
    levels:{ novice:'3×8 bodyweight to box — learn the sit-back', beginner:'3×8 light barbell', intermediate:'4×6 at 70% squat max', advanced:'4×5 at 80%+', elite:'5×3 at 90%+ — competition box squat form' }},
  { id:82, type:'ABS_LEGS', name:'Front Squat',           muscle:'Quads & Core',    equipment:'Barbell',
    description:'Quad-dominant squat with bar in front rack — demands upright torso and strong core.',
    steps:['Rest bar on front delts in front rack. Cross-arm or clean grip.','Keep torso vertical, squat until thighs parallel.','Drive up through heels — elbows stay high throughout.'],
    levels:{ novice:'3×8 goblet squat first to learn upright torso', beginner:'3×8 light barbell', intermediate:'4×6 at 60% back squat max', advanced:'4×4 at 75%', elite:'5×3 at 85%+ — Olympic lifting style' }},
  { id:83, type:'ABS_LEGS', name:'Step-Up',               muscle:'Quads & Glutes',  equipment:'Dumbbell',
    description:'Unilateral leg press that improves glute activation and single-leg stability.',
    steps:['Hold dumbbells at sides. Place one foot on a box (knee height).','Drive through elevated heel — push body up until standing on box.','Step down slowly with control.'],
    levels:{ novice:'3×10 per leg bodyweight — box at 30 cm', beginner:'3×10 per leg light DB', intermediate:'4×10 per leg moderate — box at knee height', advanced:'4×8 per leg heavy — box above knee', elite:'5×10 per leg barbell — 3s descent' }},
  { id:84, type:'ABS_LEGS', name:'Nordic Curl',            muscle:'Hamstrings',      equipment:'Bodyweight',
    description:'The hardest bodyweight hamstring exercise — eccentric loading produces massive strength gains.',
    steps:['Kneel, ankles fixed under bench or bar. Arms crossed on chest.','Lower torso to floor as slowly as possible — hamstrings resist.','Push off floor with hands to assist the return.'],
    levels:{ novice:'3×3 — use arms heavily, just learn the pattern', beginner:'3×5 — minimal arm assist', intermediate:'4×6 — small arm assist', advanced:'4×8 — no arm assist', elite:'5×8 — weighted vest, no arms' }},
  { id:85, type:'ABS_LEGS', name:'Glute Kickback',         muscle:'Glutes',          equipment:'Cable Machine',
    description:'Cable kickback that isolates the glute max with constant tension — essential for glute shaping.',
    steps:['Attach ankle cuff to low cable. Face the machine, slight forward lean.','Kick working leg back and up — squeeze glute hard at top.','Return slowly — do not swing.'],
    levels:{ novice:'3×15 per side light — squeeze at top', beginner:'3×15 per side moderate', intermediate:'4×15 per side heavy', advanced:'4×20 per side — 2s hold at top', elite:'5×20 per side — max load + partial reps' }},
  { id:86, type:'ABS_LEGS', name:'Sumo Squat',             muscle:'Glutes & Adductors',equipment:'Dumbbell',
    description:'Wide-stance squat that emphasizes glutes and inner thighs — more upright torso than regular squat.',
    steps:['Stand wide (1.5× shoulder), toes pointed 45° out. Hold one heavy dumbbell.','Squat straight down — knees track toes, torso upright.','Drive up by pushing knees out — squeeze glutes at top.'],
    levels:{ novice:'3×12 bodyweight — stance and knees focus', beginner:'3×12 light DB', intermediate:'4×12 moderate DB', advanced:'4×10 heavy DB — 3s descent', elite:'5×10 barbell sumo or heavy DB — paused at bottom' }},
  { id:87, type:'ABS_LEGS', name:'Bicycle Crunch',         muscle:'Obliques & Abs',  equipment:'Bodyweight',
    description:'The highest-rated ab exercise by EMG studies — combines rotation with leg drive.',
    steps:['Lie on back, hands behind head, feet off floor.','Bring right knee and left elbow toward each other — rotate, not just flex.','Extend right leg, switch sides in a pedaling motion.'],
    levels:{ novice:'3×10 per side — slow, full rotation', beginner:'3×15 per side moderate', intermediate:'4×20 per side', advanced:'4×25 per side — slower for more TUT', elite:'5×30 per side — ankle weights or resistance' }},
  { id:88, type:'ABS_LEGS', name:'Dragon Flag',            muscle:'Full Core',       equipment:'Bodyweight',
    description:'Bruce Lee\'s signature exercise — one of the most demanding core movements in existence.',
    steps:['Lie on bench, grip edge behind head.','Raise body to vertical support on shoulder blades only.','Lower entire straight body as slowly as possible.'],
    levels:{ novice:'3×3 — tuck version (knees bent)', beginner:'3×5 — one leg extended variation', intermediate:'4×5 — full flag, slow descent', advanced:'4×6 — pause halfway down', elite:'5×8 — full range, no pause, weighted ankle' }},
  { id:89, type:'ABS_LEGS', name:'L-Sit Hold',             muscle:'Core & Hip Flexors',equipment:'Bars',
    description:'Static compression hold that builds the entire anterior chain and prepares for gymnastics.',
    steps:['Support body on parallel bars or dip station.','Lift legs straight out in front — body forms an L shape.','Hold position, breathing normally.'],
    levels:{ novice:'3×5s — tuck L-sit with knees bent', beginner:'3×10s tuck', intermediate:'4×15s — one leg extended', advanced:'4×20s — full L-sit', elite:'5×30s — full L-sit, add progression to V-sit' }},
  { id:90, type:'ABS_LEGS', name:'Sissy Squat',            muscle:'Quads',           equipment:'Bodyweight',
    description:'Old-school quad isolation that provides deep stretch and peak contraction impossible with normal squats.',
    steps:['Hold support lightly for balance. Feet together, heels raised.','Lean back and lower by bending knees — torso and thighs stay aligned.','Return up by driving through quads — not hips.'],
    levels:{ novice:'3×8 partial range — hold support firmly', beginner:'3×10 half range', intermediate:'4×12 full range', advanced:'4×15 — add light plate on chest', elite:'5×15 — weighted plate + slow eccentric 4s' }},

  // ── CARDIO extra (91–100) ─────────────────────────────────────────────────────
  { id:91, type:'CARDIO', name:'Shadow Boxing',      muscle:'Upper Body & Core',  equipment:'None',
    description:'Freestyle striking drill that builds cardiovascular fitness, coordination, and mental focus.',
    steps:['Stand in fighting stance, hands up at chin height.','Throw combinations: jab-cross-hook-uppercut, moving constantly.','Stay light on feet — never stop moving.'],
    levels:{ novice:'3×1 min — basic jab-cross only, walk between rounds', beginner:'3×2 min rounds, 60s rest', intermediate:'5×2 min — full combinations + footwork', advanced:'5×3 min — slip-and-counter patterns', elite:'8×3 min — 1 min rest, competition pace' }},
  { id:92, type:'CARDIO', name:'Kettlebell Swing',   muscle:'Full Posterior Chain',equipment:'Kettlebell',
    description:'Hip-hinge power movement that develops explosive glutes and elevates heart rate rapidly.',
    steps:['Hike kettlebell back between legs — hip hinge, not a squat.','Explosively snap hips forward — bell floats to shoulder height.','Let bell swing back, reload the hinge — continuous rhythm.'],
    levels:{ novice:'3×10 — hip hinge mechanics first, no momentum', beginner:'3×15 light KB', intermediate:'4×20 moderate KB', advanced:'4×25 heavy KB — one-arm variation', elite:'5×30 heavy — alternating one-arm, non-stop' }},
  { id:93, type:'CARDIO', name:'Assault Bike',       muscle:'Full Body',          equipment:'Bike',
    description:'Air resistance bike — the harder you push, the harder it gets. Maximum cardiovascular challenge.',
    steps:['Grip handles and pedal simultaneously — push and pull the arms.','Maintain a rhythmic breathing pattern.','For intervals: sprint then active recovery, never stop completely.'],
    levels:{ novice:'10 min steady pace — moderate effort', beginner:'5×1 min effort / 2 min easy', intermediate:'8×30s all-out / 90s easy', advanced:'10×20s max effort / 40s rest', elite:'Tabata: 8×20s/10s — maximum output every round' }},
  { id:94, type:'CARDIO', name:'Incline Walk',       muscle:'Glutes & Cardio',    equipment:'None',
    description:'Incline treadmill walking burns as many calories as running with zero impact on joints.',
    steps:['Set treadmill at 10–15% incline.','Walk at 4–6 km/h — do not hold the handrails.','Lean forward slightly from ankles, not waist.'],
    levels:{ novice:'15 min at 8% incline, 4 km/h', beginner:'20 min at 10%, 4.5 km/h', intermediate:'30 min at 12%, 5 km/h', advanced:'45 min at 15%, 5.5 km/h', elite:'60 min at 15% — weighted vest, no handrails' }},
  { id:95, type:'CARDIO', name:'Sled Push',          muscle:'Full Body',          equipment:'Machine',
    description:'Loaded sled sprint that develops leg power, cardiovascular fitness, and mental toughness simultaneously.',
    steps:['Load sled to appropriate weight. Grip handles at hip height.','Lean into sled at 45° — drive with alternating powerful strides.','Maintain constant pressure — do not let sled slow down.'],
    levels:{ novice:'4×10m empty sled — learn the lean', beginner:'4×20m light load', intermediate:'5×20m moderate load', advanced:'6×30m heavy load — 60s rest', elite:'8×40m max load — 90s rest — timed' }},
  { id:96, type:'CARDIO', name:'Lateral Shuffle',    muscle:'Legs & Core',        equipment:'None',
    description:'Lateral agility drill that improves hip abductor strength, coordination, and change-of-direction speed.',
    steps:['Athletic stance: slight squat, core tight, weight on balls of feet.','Push off and slide feet laterally — do not cross feet.','Touch a line or cone, change direction explosively.'],
    levels:{ novice:'3×20s — slow controlled shuffles', beginner:'3×30s — moderate pace', intermediate:'4×40s — fast with cones 5m apart', advanced:'5×45s — resistance bands at ankles', elite:'5×60s — bands + direction change on signal' }},
  { id:97, type:'CARDIO', name:'Broad Jump',         muscle:'Legs & Explosiveness',equipment:'None',
    description:'Maximal horizontal jump that develops explosive power and teaches landing mechanics.',
    steps:['Stand with feet shoulder-width, bend knees and swing arms back.','Explode forward — maximum horizontal distance.','Land softly on both feet, absorbing force with bent knees.'],
    levels:{ novice:'3×4 reps — focus on soft landing', beginner:'3×5 reps — add arm swing', intermediate:'4×5 reps — max distance each jump', advanced:'4×6 reps — continuous broad jumps', elite:'5×6 reps — weighted vest or immediate sprint after landing' }},
  { id:98, type:'CARDIO', name:'Jump Lunge',         muscle:'Legs & Core',        equipment:'None',
    description:'Plyometric split lunge that builds explosive single-leg power and torches calories.',
    steps:['Start in lunge position, back knee near floor.','Explosively jump and switch legs in mid-air.','Land in opposite lunge position — absorb softly.'],
    levels:{ novice:'3×5 per leg — step instead of jump first', beginner:'3×8 per leg — small jump', intermediate:'4×10 per leg continuous', advanced:'4×12 per leg — minimal ground contact time', elite:'5×15 per leg — weighted vest, maximum height' }},
  { id:99, type:'CARDIO', name:'Agility Ladder',     muscle:'Full Body & Coordination',equipment:'None',
    description:'Foot speed and coordination drill that improves athletic performance and burns significant calories.',
    steps:['Place ladder flat. Start at one end, feet ready.','Move through ladder using chosen pattern (1-in, 2-in, ickey shuffle, etc.).','Stay on balls of feet — arms pump for speed.'],
    levels:{ novice:'3×1 length — slow, 1-in pattern only', beginner:'3×2 lengths — 2 patterns', intermediate:'4×3 lengths — 4 patterns, minimal rest', advanced:'5×4 lengths — max speed each pass', elite:'6×4 lengths — all patterns, change direction, reactive cues' }},
  { id:100, type:'CARDIO', name:'Plyo Push-up',      muscle:'Chest & Explosiveness',equipment:'Bodyweight',
    description:'Explosive push-up variant that develops upper body power and fast-twitch muscle activation.',
    steps:['Start in standard push-up position.','Lower to full depth, then explode up so hands leave floor.','Land with bent elbows — absorb and immediately go into next rep.'],
    levels:{ novice:'3×3 — just a quick push with no airtime yet', beginner:'3×5 — hands clear floor slightly', intermediate:'4×8 — clap between reps', advanced:'4×10 — chest clap or double clap', elite:'5×10 — triple clap or weighted vest, 30s rest only' }},
]
